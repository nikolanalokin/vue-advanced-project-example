...
class ShortNameEmoji extends Module {
  ...
  onTextChange (delta, oldDelta, source) {
    // console.log('onTextChange', delta, oldDelta, source)
    // let selection = this.quill.getSelection(true)
    // console.log('selection', selection)
    // let query = this.quill.getText(selection.index, 2)
    ...
    //   cursorPosition = 0
    // }
    // this.quill.insertEmbed(cursorPosition, 'emoji', '1F51E', Quill.sources.USER);
  }
