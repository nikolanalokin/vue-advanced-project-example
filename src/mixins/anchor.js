...
export default {
  ...
  methods: {
    ...
    __unconfigureAnchorEl (context = this.contextMenu) {
      if (context === true) {
        if (this.$platform.is.mobile) {
          ...
          this.anchorEl.removeEventListener('mouseenter', this.hide)
          this.anchorEl.removeEventListener('contextmenu', this.__contextClick)
        }
      }
      else {
        this.anchorEl.removeEventListener('mouseenter', this.toggle)
    ...
    __configureAnchorEl (context = this.contextMenu) {
      ...
      if (context === true) {
        if (this.triggerEvent == 'hover') {
          this.anchorEl.addEventListener('mouseenter', this.hide)
        } else {
        ...
        if (this.triggerEvent == 'hover') {
          this.anchorEl.addEventListener('mouseenter', this.toggle)
        } else {
    ...
    __setAnchorEl (el) {
      this.anchorEl = el
      while (this.anchorEl.classList.contains('n-anchor--skip')) {
